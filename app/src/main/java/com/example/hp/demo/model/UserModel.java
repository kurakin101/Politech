...
public class UserModel {
    ...
    public UserModel(String userDisplayName, String userEmail, long time, int compMarksB, int compMarksI, int compMarksE, int hardwareMarksB, int hardwareMarksI, int hardwareMarksE, int osMarksB, int osMarksI, int osMarksE, int finalMarks) {
    }

    public UserModel(String displayName, String launch, String email,long createdAt,int compMarksB,int compMarksI,int compMarksE,int hardwareMarksB,int hardwareMarksI,int hardwareMarksE,int osMarksB,int osMarksI,int osMarksE,int finalMarks) {
